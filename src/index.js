...
const window_height = portfolio.offsetHeight;
const window_width = portfolio.offsetWidth;

console.log(portfolio);
console.log(window_height);
console.log(window_width);

const randomLocation = (num) => Math.round(Math.random() * num);

imagesArr.forEach(img => {    
  img.style.position = 'absolute';
  img.style.top = randomLocation(window_height) + 'px';
  img.style.left = randomLocation(window_width) + 'px';
});
